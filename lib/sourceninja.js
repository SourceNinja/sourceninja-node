...
cljs.core.missing_protocol = function(a, b) {
  return Error("No protocol method " + a + " defined for type " + goog.typeOf(b) + ": " + b)
};
...
cljs.core.compare = function(a, b) {
  ...
  if(cljs.core.type.call(null, a) === cljs.core.type.call(null, b)) {
    return(null != a ? cljs.core.truth_(cljs.core.truth_(null) ? null : a.cljs$core$IComparable$) || (a.cljs$lang$protocol_mask$partition$ ? 0 : cljs.core.type_satisfies_.call(null, cljs.core.IComparable, a)) : cljs.core.type_satisfies_.call(null, cljs.core.IComparable, a)) ? cljs.core._compare.call(null, a, b) : goog.array.defaultCompare(a, b)
  }
...
cljs.core.Keyword.prototype.cljs$core$IFn$ = !0;
...
cljs.core.vector_seq = function vector_seq$$0(b, c) {
  ...
  return 0 < d ? (void 0 === cljs.core.t5123 && (cljs.core.t5123 = function(b, c, d, h, i) {
    this.c = b;
    this.offset = c;
    this.v = d;
    this.vector_seq = h;
    this.__meta__296__auto__ = i;
    this.cljs$lang$protocol_mask$partition1$ = 0;
    this.cljs$lang$protocol_mask$partition0$ = 282263656
  }, cljs.core.t5123.cljs$lang$type = !0, cljs.core.t5123.cljs$lang$ctorPrSeq = function() {
    return cljs.core.list.call(null, "cljs.core.t5123")
  }, cljs.core.t5123.prototype.cljs$core$ICollection$ = !0, cljs.core.t5123.prototype.cljs$core$ICollection$_conj$arity$2 = function(b, c) {
    return cljs.core.cons.call(null, c, b)
  }, cljs.core.t5123.prototype.cljs$core$ISeqable$ = !0, cljs.core.t5123.prototype.cljs$core$ISeqable$_seq$arity$1 = function(b) {
    return b
  }, cljs.core.t5123.prototype.cljs$core$ISeq$ = !0, cljs.core.t5123.prototype.cljs$core$ISeq$_first$arity$1 = function() {
    return cljs.core._nth.call(null, this.v, this.offset)
  }, cljs.core.t5123.prototype.cljs$core$ISeq$_rest$arity$1 = function() {
    var b = this.offset + 1;
    return b < this.c ? this.vector_seq.call(null, this.v, b) : cljs.core.List.EMPTY
  }, cljs.core.t5123.prototype.cljs$core$ASeq$ = !0, cljs.core.t5123.prototype.cljs$core$IEquiv$ = !0, cljs.core.t5123.prototype.cljs$core$IEquiv$_equiv$arity$2 = function(b, c) {
    return cljs.core.equiv_sequential.call(null, b, c)
  }, cljs.core.t5123.prototype.cljs$core$ISequential$ = !0, cljs.core.t5123.prototype.cljs$core$IPrintable$ = !0, cljs.core.t5123.prototype.cljs$core$IPrintable$_pr_seq$arity$2 = function(b, c) {
    return cljs.core.pr_sequential.call(null, cljs.core.pr_seq, "(", " ", ")", c, b)
  }, cljs.core.t5123.prototype.cljs$core$IMeta$ = !0, cljs.core.t5123.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
    return this.__meta__296__auto__
  }, cljs.core.t5123.prototype.cljs$core$IWithMeta$ = !0, cljs.core.t5123.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
    return new cljs.core.t5123(this.c, this.offset, this.v, this.vector_seq, c)
  }, cljs.core.t5123), new cljs.core.t5123(d, c, b, vector_seq$$0, null)) : null
};
...
cljs.core.ObjMap.prototype.cljs$core$IAssociative$_assoc$arity$3 = function(a, b, c) {
  if(goog.isString(b)) {
    ...
    if(d) {
      return a = cljs.core.obj_clone.call(null, this.strobj, this.keys), d = this.keys.slice(), a[b] = c, d.push(b), new cljs.core.ObjMap(this.meta, d, a, this.update_count + 1, null)
    }
  }
...
cljs.core.reset_BANG_ = function(a, b) {
  ...
  if(cljs.core.truth_(c) && !cljs.core.truth_(c.call(null, b))) {
    throw Error([cljs.core.str("Assert failed: "), cljs.core.str("Validator rejected reference state"), cljs.core.str("\n"), cljs.core.str(cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'validate", "\ufdd1'new-value"), cljs.core.hash_map("\ufdd0'line", 5971))))].join(""));
  }
  c = a.state;
  a.state = b;
...
cljs.core.js__GT_clj = function() {
  var a = function(a, b) {
    ...
    return function h(a) {
      return cljs.core.seq_QMARK_.call(null, a) ? cljs.core.doall.call(null, cljs.core.map.call(null, h, a)) : cljs.core.coll_QMARK_.call(null, a) ? cljs.core.into.call(null, cljs.core.empty.call(null, a), cljs.core.map.call(null, h, a)) : cljs.core.truth_(goog.isArray(a)) ? cljs.core.vec.call(null, cljs.core.map.call(null, h, a)) : cljs.core.type.call(null, a) === Object ? cljs.core.into.call(null, cljs.core.ObjMap.fromObject([], {}), function() {
        return function k(b) {
          return new cljs.core.LazySeq(null, !1, function() {
            for(;;) {
              if(cljs.core.truth_(cljs.core.seq.call(null, b))) {
...
cljs.core.group_by = function(a, b) {
  return cljs.core.reduce.call(null, function(b, d) {
    var e = a.call(null, d);
    return cljs.core.assoc.call(null, b, e, cljs.core.conj.call(null, cljs.core._lookup.call(null, b, e, cljs.core.PersistentVector.fromArray([])), d))
...
cljs.core.derive = function() {
  var a = null, b = function(b, c) {
    if(!cljs.core.truth_(cljs.core.namespace.call(null, c))) {
      throw Error([cljs.core.str("Assert failed: "), cljs.core.str(cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'namespace", "\ufdd1'parent"), cljs.core.hash_map("\ufdd0'line", 6255))))].join(""));
    }
    cljs.core.swap_BANG_.call(null, cljs.core.global_hierarchy, a, b, c);
    return null
  }, c = function(a, b, c) {
    if(!cljs.core.not_EQ_.call(null, b, c)) {
      throw Error([cljs.core.str("Assert failed: "), cljs.core.str(cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'not=", "\ufdd1'tag", "\ufdd1'parent"), cljs.core.hash_map("\ufdd0'line", 6259))))].join(""));
    }
...
var sourceninja = {core:{}};
sourceninja.core.env = process.env;
sourceninja.core.npm = cljs.nodejs.require.call(null, "npm");
sourceninja.core.https = cljs.core.truth_(sourceninja.core.env.SOURCENINJA_HTTP) ? cljs.nodejs.require.call(null, "http") : cljs.nodejs.require.call(null, "https");
sourceninja.core.sn_post_port = function() {
  var a = sourceninja.core.env.SOURCENINJA_PORT;
  return cljs.core.truth_(a) ? parseInt(a) : 443
}();
sourceninja.core.sn_post_host = function() {
  var a = sourceninja.core.env.SOURCENINJA_HOSTNAME;
  return cljs.core.truth_(a) ? a : "app.sourceninja.com"
}();
sourceninja.core.boundary = "blargl";
sourceninja.core.sn_post_url = function(a) {
  return[cljs.core.str("/products/"), cljs.core.str(a), cljs.core.str("/imports")].join("")
};
sourceninja.core.make_js_map = function(a) {
  var b = {};
...
sourceninja.core.encode_field_part = function(a, b, c) {
  return[cljs.core.str("--"), cljs.core.str(a), cljs.core.str("\r\n"), cljs.core.str('Content-Disposition: form-data; name="'), cljs.core.str(b), cljs.core.str('"\r\n\r\n'), cljs.core.str(c), cljs.core.str("\r\n")].join("")
};
sourceninja.core.encode_file_part = function(a, b, c, d) {
  return[cljs.core.str("--"), cljs.core.str(a), cljs.core.str("\r\n"), cljs.core.str('Content-Disposition: form-data; name="'), cljs.core.str(c), cljs.core.str('"; filename="'), cljs.core.str(d), cljs.core.str('"\r\n'), cljs.core.str("Content-Type: "), cljs.core.str(b), cljs.core.str("\r\n\r\n")].join("")
};
sourceninja.core.create_headers = function(a, b) {
  return sourceninja.core.make_js_map.call(null, cljs.core.ObjMap.fromObject(["Content-Type", "Content-Length"], {"Content-Type":[cljs.core.str("multipart/form-data; boundary="), cljs.core.str(b)].join(""), "Content-Length":a.length}))
};
sourceninja.core.post_options = function(a, b) {
  return sourceninja.core.make_js_map.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'hostname", "\ufdd0'port", "\ufdd0'path", "\ufdd0'method", "\ufdd0'headers"], {"\ufdd0'hostname":sourceninja.core.sn_post_host, "\ufdd0'port":sourceninja.core.sn_post_port, "\ufdd0'path":a, "\ufdd0'method":"POST", "\ufdd0'headers":b}))
};
sourceninja.core.json_generate = function(a) {
  return[cljs.core.str(JSON.stringify.call(null, cljs.core.apply.call(null, cljs.core.array, cljs.core.map.call(null, sourceninja.core.make_js_map, a)))), cljs.core.str("\n")].join("")
};
sourceninja.core.format_deps = function(a, b) {
  return function d(a) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        if(cljs.core.truth_(cljs.core.seq.call(null, a))) {
          var f = cljs.core.first.call(null, a), g = cljs.core.nth.call(null, f, 0, null), f = cljs.core.nth.call(null, f, 1, null);
          return cljs.core.cons.call(null, cljs.core.ObjMap.fromObject(["name", "version", "direct"], {name:g, version:cljs.core._lookup.call(null, f, "version", null), direct:cljs.core.contains_QMARK_.call(null, b, g)}), d.call(null, cljs.core.rest.call(null, a)))
        }
        return null
      }
    })
...
sourceninja.core.flatten_deps = function(a) {
  for(var b = cljs.core.ObjMap.fromObject([], {}), c = a;;) {
    if(cljs.core.not.call(null, cljs.core.empty_QMARK_.call(null, c))) {
      var d = cljs.core.remove.call(null, cljs.core.partial.call(null, cljs.core.contains_QMARK_, b), cljs.core.keys.call(null, c)), a = cljs.core.reduce.call(null, function(a, b) {
        return function(a, c) {
          return cljs.core.assoc.call(null, a, c, cljs.core._lookup.call(null, b, c, null))
        }
      }(b, c), b, d), c = cljs.core.apply.call(null, cljs.core.merge, cljs.core.map.call(null, function(a, b) {
        return function(a) {
          return cljs.core._lookup.call(null, cljs.core._lookup.call(null, b, a, null), "dependencies", null)
        }
      }(b, c), d)), b = a
    }else {
      return b
...
sourceninja.core.conn_response_handler = function(a) {
  a = a.statusCode;
  return cljs.core._EQ_.call(null, a, 201) ? cljs.core.println.call(null, "Sent data to SourceNinja") : cljs.core.println.call(null, "Error sending data to SourceNinja:", a)
};
sourceninja.core.conn_refused_handler = function(a, b) {
  cljs.core.println.call(null, "Error connecting to SourceNinja");
  cljs.core.println.call(null, "HOST", sourceninja.core.sn_post_host);
  cljs.core.println.call(null, "PORT", sourceninja.core.sn_post_port);
  cljs.core.println.call(null, "PATH", a);
  return cljs.core.println.call(null, "EXCEPTION", cljs.core.js__GT_clj.call(null, b))
};
sourceninja.core.post_deps = function(a, b, c) {
  a = sourceninja.core.sn_post_url.call(null, a);
  c = sourceninja.core.json_generate.call(null, sourceninja.core.format_deps.call(null, sourceninja.core.flatten_deps.call(null, c), cljs.core.set.call(null, cljs.core.keys.call(null, c))));
  b = [cljs.core.str(sourceninja.core.encode_field_part.call(null, sourceninja.core.boundary, "token", b)), cljs.core.str(sourceninja.core.encode_field_part.call(null, sourceninja.core.boundary, "meata_source_type", "node")), cljs.core.str(sourceninja.core.encode_field_part.call(null, sourceninja.core.boundary, "import_type", "json")), cljs.core.str(sourceninja.core.encode_file_part.call(null, sourceninja.core.boundary, "application/json", "import[import]", "node.json")), cljs.core.str(c), cljs.core.str("\r\n--"), 
  cljs.core.str(sourceninja.core.boundary), cljs.core.str("--")].join("");
  c = sourceninja.core.create_headers.call(null, b, sourceninja.core.boundary);
  c = sourceninja.core.post_options.call(null, a, c);
  c = sourceninja.core.https.request(c, sourceninja.core.conn_response_handler);
  c.on("error", cljs.core.partial.call(null, sourceninja.core.conn_refused_handler, a));
  c.write(b);
  return c.end()
};
sourceninja.core.npm_ls_callback = function(a, b, c, d, e) {
  c = cljs.core.js__GT_clj.call(null, e.dependencies);
  return sourceninja.core.post_deps.call(null, a, b, c)
};
sourceninja.core.load_npm_callback = function(a, b, c, d) {
  return d.commands.ls(cljs.core.PersistentVector.fromArray([]), !0, cljs.core.partial.call(null, sourceninja.core.npm_ls_callback, a, b))
};
sourceninja.core.kapow = function() {
  var a = null, b = function() {
    return a.call(null, sourceninja.core.env.SOURCENINJA_PRODUCT_ID, sourceninja.core.env.SOURCENINJA_TOKEN)
  }, c = function(a, b) {
    return cljs.core._EQ_.call(null, a, void 0) ? cljs.core.println.call(null, "Product ID is not set, can't send data to SourceNinja") : cljs.core._EQ_.call(null, b, void 0) ? cljs.core.println.call(null, "Product token is not set, can't send data to SourceNinja") : sourceninja.core.npm.load(cljs.core.partial.call(null, sourceninja.core.load_npm_callback, a, b))
  }, a = function(a, e) {
    switch(arguments.length) {
      case 0:
        return b.call(this);
...
goog.exportSymbol("sourceninja.core.kapow", sourceninja.core.kapow);
sourceninja.core.noop = function() {
  return null
};
cljs.core._STAR_main_cli_fn_STAR_ = sourceninja.core.noop;
cljs.nodejscli = {};
