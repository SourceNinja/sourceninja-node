...
sourceninja.core.sn_product_token = sourceninja.core.env.SOURCENINJA_PRODUCT_TOKEN;
...
sourceninja.core.conn_response_handler = function(a) {
  cljs.core.println.call(null, cljs.core.str.call(null, "status: ", a.statusCode));
  cljs.core.println.call(null, cljs.core.str.call(null, "headers: ", cljs.core.js__GT_clj.call(null, a.headers)));
  return a.on("data", cljs.core.println)
};
...
sourceninja.core.kapow = function() {
  return sourceninja.core.npm.load(sourceninja.core.load_npm_callback)
};
