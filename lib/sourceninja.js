...
sourceninja.core.sn_product_id = sourceninja.core.env.SOURCENINJA_PRODUCT_ID;
sourceninja.core.sn_product_token = sourceninja.core.env.SOURCENINJA_TOKEN;
sourceninja.core.boundary = "blargl";
sourceninja.core.sn_post_url = cljs.core.str.call(null, "/products/", sourceninja.core.sn_product_id, "/imports");
...
sourceninja.core.encode_file_part = function(a, b, c, d) {
  return cljs.core.str.call(null, "--", a, "\r\n", 'Content-Disposition: form-data; name="', c, '"; filename="', d, '"\r\n', "Content-Type: ", b, "\r\n\r\n")
};
sourceninja.core.create_headers = function(a, b) {
  return sourceninja.core.make_js_map.call(null, cljs.core.PersistentHashMap.fromArrays(["Content-Type", "Content-Length"], [cljs.core.str.call(null, "multipart/form-data; boundary=", b), a.length]))
};
sourceninja.core.post_options = function(a) {
  return sourceninja.core.make_js_map.call(null, cljs.core.PersistentHashMap.fromArrays(["\ufdd0'hostname", "\ufdd0'port", "\ufdd0'path", "\ufdd0'method", "\ufdd0'headers"], [sourceninja.core.sn_post_host, sourceninja.core.sn_post_port, sourceninja.core.sn_post_url, "POST", a]))
};
sourceninja.core.json_generate = function(a) {
  return cljs.core.str.call(null, JSON.stringify.call(null, cljs.core.apply.call(null, cljs.core.array, cljs.core.map.call(null, sourceninja.core.make_js_map, a))), "\n")
};
    ...
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        if(cljs.core.truth_(cljs.core.seq.call(null, a))) {
          ...
          return cljs.core.cons.call(null, cljs.core.PersistentHashMap.fromArrays(["name", "version", "direct"], [g, cljs.core.get.call(null, f, "version"), cljs.core.contains_QMARK_.call(null, b, g)]), d.call(null, cljs.core.rest.call(null, a)))
        }
        return null
      }
    })
...
sourceninja.core.flatten_deps = function(a) {
  for(var b = cljs.core.PersistentHashMap.fromArrays([], []), c = a;;) {
    if(cljs.core.not.call(null, cljs.core.empty_QMARK_.call(null, c))) {
      var d = cljs.core.remove.call(null, cljs.core.partial.call(null, cljs.core.contains_QMARK_, b), cljs.core.keys.call(null, c)), a = cljs.core.reduce.call(null, function(a, b) {
        return function(a, c) {
          return cljs.core.assoc.call(null, a, c, cljs.core.get.call(null, b, c))
        }
      }(b, c), b, d), c = cljs.core.apply.call(null, cljs.core.merge, cljs.core.map.call(null, function(a, b) {
        return function(a) {
          return cljs.core.get.call(null, cljs.core.get.call(null, b, a), "dependencies")
        }
      }(b, c), d)), b = a
    }else {
      return b
...
sourceninja.core.conn_refused_handler = function(a) {
  ...
  cljs.core.println.call(null, "PATH", sourceninja.core.sn_post_url);
  return cljs.core.println.call(null, "EXCEPTION", cljs.core.js__GT_clj.call(null, a))
};
sourceninja.core.post_deps = function(a) {
  var a = sourceninja.core.json_generate.call(null, sourceninja.core.format_deps.call(null, sourceninja.core.flatten_deps.call(null, a), cljs.core.set.call(null, cljs.core.keys.call(null, a)))), a = cljs.core.str.call(null, sourceninja.core.encode_field_part.call(null, sourceninja.core.boundary, "token", sourceninja.core.sn_product_token), sourceninja.core.encode_field_part.call(null, sourceninja.core.boundary, "meata_source_type", "node"), sourceninja.core.encode_field_part.call(null, sourceninja.core.boundary, 
  "import_type", "json"), sourceninja.core.encode_file_part.call(null, sourceninja.core.boundary, "application/json", "import[import]", "node.json"), a, "\r\n--", sourceninja.core.boundary, "--"), b = sourceninja.core.create_headers.call(null, a, sourceninja.core.boundary), b = sourceninja.core.post_options.call(null, b), b = sourceninja.core.https.request(b, sourceninja.core.conn_response_handler);
  b.on("error", sourceninja.core.conn_refused_handler);
  b.write(a);
  return b.end()
};
sourceninja.core.npm_ls_callback = function(a, b, c) {
  a = cljs.core.js__GT_clj.call(null, c.dependencies);
  return sourceninja.core.post_deps.call(null, a)
};
sourceninja.core.load_npm_callback = function(a, b) {
  return b.commands.ls(cljs.core.PersistentVector.fromArray([]), !0, sourceninja.core.npm_ls_callback)
};
sourceninja.core.kapow = function() {
  return cljs.core._EQ_.call(null, sourceninja.core.sn_product_id, void 0) ? cljs.core.println.call(null, "Environment variable SOURCENINJA_PRODUCT_ID is not set, can't send data to SourceNinja") : cljs.core._EQ_.call(null, sourceninja.core.sn_product_token, void 0) ? cljs.core.println.call(null, "Environment variable SOURCENINJA_TOKEN is not set, can't send data to SourceNinja") : sourceninja.core.npm.load(sourceninja.core.load_npm_callback)
};
